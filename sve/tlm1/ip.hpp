...
{   
    public:
        ...
        tlm_utils::simple_initiator_socket<Ip> rom_socket;
    				...
    				sc_port<sc_fifo_in_if<sc_dt::sc_uint<16>>> p_fifo_in;  // Input FIFO for reading data
    				sc_port<sc_fifo_out_if<sc_dt::sc_uint<16>>> p_fifo_out; // Output FIFO for writing results
    ...
    protected:
        ...
        sc_dt::sc_uint<16> num1, num2;
    				sc_dt::sc_uint<16> result;  
    				sc_uint<1> ready_sum; 
};
